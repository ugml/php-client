<?php
    ...
    class C_Research implements I_Controller {
        ...
        function build($buildID) : void {
            ...
            try {
                if($buildID < 100 || $buildID > 199 || !array_key_exists($buildID, $data->getUnits()->getTechnologies())) {
                ...
                if($data->getPlanet()->getBTechId() == 0) {
                    ...
                    if($data->getPlanet()->getMetal() >= $metal &&
                        ...
                        M_Research::build($data->getPlanet()->getPlanetId(), $buildID, $toLvl, $n_metal, $n_crystal, $n_deuterium);
                        header("Refresh:0");
        ...
        function display() : void {
            ...
            $this->lang['research_list'] = $view->loadResearchRows($data->getTech(), $data->getUnits()->getTechnologies(), $data->getPlanet());
