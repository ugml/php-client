                        ...
                        <div class="col-md-12">
                            <?php
                                if($this->_['lang']['planet_metal'] >= $this->_['lang']['planet_metal_max']) {
                                    echo "<span class=\"negative\">".number_format($this->_['lang']['planet_metal'], 0)."</span>";
                                } else {
                        ...
                        <div class="col-md-12">
                            <?php
                                if($this->_['lang']['planet_crystal'] >= $this->_['lang']['planet_crystal_max']) {
                                    echo "<span class=\"negative\">".number_format($this->_['lang']['planet_crystal'], 0)."</span>";
                                } else {
                        ...
                        <div class="col-md-12">
                            ...
                            //die($this->_['lang']['planet_deuterium'] ." - " . $this->_['lang']['planet_deuterium_max']);
                                if($this->_['lang']['planet_deuterium'] >= $this->_['lang']['planet_deuterium_max']) {
                                    echo "<span class=\"negative\">".number_format($this->_['lang']['planet_deuterium'], 0)."</span>";
                                } else {
