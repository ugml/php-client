<?php
    ...
    class Tech {
        ...
        public function __construct(int $respionage_tech, int $rcomputer_tech, int $rweapon_tech, int $rarmour_tech, int $rshielding_tech, int $renergy_tech, int $rhyperspace_tech, 
                                    int $rcombustion_drive_tech, int $rimpulse_drive_tech, int $rhyperspace_drive_tech, int $rlaser_tech, int $rion_tech, int $rplasma_tech, 
