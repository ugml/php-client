    ...
    class Loader {
        ...
        function __construct($userID) {
            ...
            while ($data = $stmt->fetch()) {
                ...
                $p = new PlanetData(intval($data->planet_planetID), intval($userID), $data->planet_name,
                ...
                if ($data->user_currentplanet == $data->planet_planetID) {
                    ...
                    $this->building = new BuildingData(intval($data->building_metal_mine),
                    ...
                    $this->defense = new DefenseData(intval($data->defense_rocket_launcher),
                    ...
                    $this->fleet = new FleetData(intval($data->fleet_small_cargo_ship),
                    ...
                    $this->tech = new TechData(intval($data->tech_espionage_tech), intval($data->tech_computer_tech),
         ...
         * @return PlanetData
         */
        public function getPlanet() : PlanetData {
         ...
         * @return DefenseData
         */
        public function getDefense() : DefenseData {
         ...
         * @return TechData
         */
        public function getTech() : TechData {
         ...
         * @return FleetData
         */
        public function getFleet() : FleetData {
         ...
         * @return UnitsData
         */
        public function getUnits() : UnitsData {
